...
#define DRIVER_VERSION			"3.0.13.0.251126"
...
#define DUMP_FLASH_PATH				"/home/wnk/shumei-chumoping/ilitek_v3/backup/flash_dump.bin"
...
#define FLASH_DMA_CHANNEL_SEL_ADDR		0x41048
#define FLASH_reg_stop_clk_en			BIT(24)
#define FLASH_reg_dma_channel_sel		(BIT(25)|BIT(26)|BIT(27))
...
extern int ili_report_handler_poll(void);
...
extern int ili_i2c_poll_read(u8 *buf, int len);
...
extern int ratio_percent(int num, int den);
